...
> {
  ...
  constructor(
    @inject('datasources.mondodb') dataSource: MondodbDataSource, @repository.getter('UsuarioRepository') protected usuarioRepositoryGetter: Getter<UsuarioRepository>,
  ) {
